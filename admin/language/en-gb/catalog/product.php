...
$_['entry_primary_category'] = 'Primary Breadcrumb Category';
$_['text_primary_category_auto'] = '-- Auto (detect from path) --';
...
$_['help_primary_category']  = 'When a product is in more than one category, choose which category is always shown in the breadcrumb on the product page, no matter how the visitor reached it (direct link, Google Ad, etc.).';
